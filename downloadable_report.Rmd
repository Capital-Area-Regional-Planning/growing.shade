...
<center>
![](`r paste0(params$param_tempplot)`){width=70%}
</center>
...
`r params$param_landusetext`

```{r landuseplot, fig.align="center", out.width= "70%", fig.asp = .9, fig.alt = "Figure showing what percent of tree canopy is on each land use category."}
params$param_landuseplot
```

`r params$param_opptext`


```{r planting opportunity plot, fig.align="center", out.width= "70%", fig.asp = .9, fig.alt = "Figure showing what percent of tree canopy is on each land use category."}
params$param_oppplot
```
