...
<!--
<div class="block-image" style='background-image:url("www/home_header.jpg")'>
	<div class="block-text">
	<div style="font-size:50px">Growing Shade</div>
	<br>
	<div style="font-size:30px">An interactive tool to assess, preserve, and expand tree canopy in Dane County, Wisconsin</div>
	</div>	
...
<div class="panel">
	...
	<br>
	They try out all of the pre-made themes, but ultimately decide they want to consider as many variables as possible. 
